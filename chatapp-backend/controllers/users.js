...
module.exports = {
    ...
    async ProfileView(req, res) {
        ...
        await User.update(
            {
            _id: req.body.id,
            'notification.date': { $ne: dateValue }, /* L263 */
          /* 'notification.date': { $ne: [dateValue, ''] },
            'notification.senderId': { $ne: req.user._id } */
        }, {
            $push: {
    ...
    async ChangePassword(req, res) {
        ...
        // const { error , value } = Joi.validate(req.body, schema);  /*L 270*/
